...
import 'core/cache/auth_cache_manager.dart' as _i4;
...
import 'presentation/bloc/auth_bloc/auth_bloc.dart' as _i14;
import 'presentation/bloc/bottom_navigation/bottom_navigation_bloc.dart' as _i5;
import 'presentation/bloc/product_bloc/product_bloc.dart' as _i16;
import 'presentation/bloc/registation_bloc/registration_bloc.dart' as _i13;
...
_i1.GetIt $initGetIt(
  ...
  gh.factory<_i4.AuthCacheManager>(() => _i4.AuthCacheManager());
  ...
  gh.factory<_i13.RegistrationBloc>(
      () => _i13.RegistrationBloc(gh<_i12.AuthRepository>()));
  ...
  gh.factory<_i16.ProductBloc>(
      () => _i16.ProductBloc(gh<_i11.UserRepository>()));
  return getIt;
}
